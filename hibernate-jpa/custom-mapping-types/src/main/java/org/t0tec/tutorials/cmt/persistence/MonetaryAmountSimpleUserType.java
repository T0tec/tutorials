 ...
 * <p>
 * Note that this mapping type is for legacy databases that only have a single numeric column to
 * hold monetary amounts. Every <tt>MonetaryAmount</tt> will be converted to USD (using some
 * conversion magic of the class itself) and saved to the database.
 * 
