...
import org.t0tec.tutorials.cmt.MonetaryAmount;

/**
 * This type adds parameterizable currency conversion to the normal composite user type, that is,
 * you can set the target currency for the conversion (for the value saved and loaded from the
 * database) to any ISO code in your mapping, depending on the situation/property to map. It maps a
 * two-attribute component to two database columns.
 * 
 * @see MonetaryAmountSimpleUserType
 * @author Christian Bauer
 */
public class MonetaryAmountType extends MonetaryAmountCompositeUserType implements
    ParameterizedType {
