 ...
 * <p>
 * Basically the same as the simple <tt>MonetaryAmountSimpleUserType</tt>, but implementing the
 * Hibernate <tt>CompositeUserType</tt> interface. This interface has some additional methods that
 * allow Hibernate to analyze the value type you are mapping. This is mostly useful for HQL queries:
 * with this custom mapping type, you can use the "amount" and "currency" sub-components in HQL
 * queries.
 * 
