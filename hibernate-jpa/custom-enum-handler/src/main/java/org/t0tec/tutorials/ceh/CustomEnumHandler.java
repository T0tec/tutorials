...
public class CustomEnumHandler {
  ...
  public void doWork() {
    ...
    List<Comment> badComments =
        listAndCast(secondSession
            .createQuery("from Comment c where c.rating = org.t0tec.tutorials.ceh.Rating.BAD"));
  ...
  private void getAllcomments() throws HibernateException {
    ...
    List<Comment> comments =
        listAndCast(newSession.createQuery("from Comment c order by c.rating asc"));
