...
public class User implements Serializable {
  ...
  @Column(name = "USER_ID")
  private long id;
  @Column(name = "FIRSTNAME", length = 255, nullable = false, unique = true, updatable = false)
  private String firstname;
  @Column(name = "LASTNAME", length = 255, nullable = false, unique = true, updatable = false)
  ...
  public String toString() {
    ...
    return "User [getId()=" + getId() + ", getFirstname()=" + getFirstname() + ", getLastname()="
        ...
        + ", getRanking()=" + getRanking() + ", isAdmin()=" + isAdmin() + s + "]";
  }
