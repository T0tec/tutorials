...
import org.t0tec.tutorials.otmwp.persistence.HibernateUtil;

public class OneToManyWithPosition {

  private static final Logger logger = LoggerFactory.getLogger(OneToManyWithPosition.class);

  // http://stackoverflow.com/questions/11938253/jpa-joincolumn-vs-mappedby
  public static void main(String[] args) {
    OneToManyWithPosition otmwp = new OneToManyWithPosition();
    otmwp.doWork();
  }
